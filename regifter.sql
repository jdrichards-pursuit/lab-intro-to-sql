...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift  TEXT NOT NULL, giver TEXT NOT NULL, value INT, previously_regifted BOOLEAN DEFAULT false);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('coconut candle', 'Mom', 12, FALSE),
('cold press juicer', 'Anthony', 650, FALSE),
('comforter', 'Aaliyah', 52, FALSE),
('sneakers', 'Shaniqua', 225, FALSE),
('toyota camry', 'The Boss', 12000, TRUE)
;
